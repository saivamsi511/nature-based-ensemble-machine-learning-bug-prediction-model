"""nature_based_prediction_model URL Configuration
...
from nature_based_prediction_model import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Bug_Report_Type/$', remoteuser.Predict_Bug_Report_Type, name="Predict_Bug_Report_Type"),
    ...
    url(r'^View_Prediction_Of_Bug_Report_Type_Ratio/$', serviceprovider.View_Prediction_Of_Bug_Report_Type_Ratio, name="View_Prediction_Of_Bug_Report_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Bug_Report_Type/$', serviceprovider.View_Prediction_Of_Bug_Report_Type, name="View_Prediction_Of_Bug_Report_Type"),
